...
class Atirador(Inimigo):
    def __init__(self, game, nome, sala):
        super().__init__(game, "Atirador", sala, nome)
...
CLASSES_INIMIGOS = {
    # Soldados
    "Esqueleto Soldado": EsqueletoSoldado, # fase 1 à 3
    "Demônio": Demonio, #fase  5 à 7
    'Aberração': Aberracao,#fase  6 à 7
    'Orco': Orco,#fase  3 à 7
    'Goblin': Goblin, #fase  1 à3
    'Morcego Gigante': MorcegoGigante, #fase 1 à3 
    
    # Atiradores
    "Esqueleto Arqueiro": EsqueletoArqueiro, #fase 1 à 3
    'Cultista Iniciado': CultistaIniciado, # fase 3 à 5
    "Cultista Sacerdote": CultistaSacerdote, #fase 4 à 6
    'Cultista Diácono': CultistaDiaco #fase 6 à 7
}
...
class OrdemInimigos:
    ...
    def set_defesa_inimigo(self, inimigo):
        inimigo.defense += self.status_defesa
